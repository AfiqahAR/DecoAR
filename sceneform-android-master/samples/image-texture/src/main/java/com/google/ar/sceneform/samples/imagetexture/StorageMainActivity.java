...
public class StorageMainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().addFragmentOnAttachListener((fragmentManager, fragment) -> {
            if (fragment.getId() == R.id.arFragment) {
                ...
                arFragment.setOnTapArPlaneListener(StorageMainActivity.this);
    ...
    public void loadModel() {
        WeakReference<StorageMainActivity> weakActivity = new WeakReference<>(this);
...
//                            });
            ...
            ModelRenderable.builder()
                    ...
                    .build()
                    .thenAccept(model -> {
                        StorageMainActivity activity = weakActivity.get();
                        if (activity != null) {
