...
public class EntertainmentMainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().addFragmentOnAttachListener((fragmentManager, fragment) -> {
            if (fragment.getId() == R.id.arFragment) {
                ...
                arFragment.setOnTapArPlaneListener(EntertainmentMainActivity.this);
...
//            furniture = extras.getString("entertainment");
    ...
    public void loadModel() {
        WeakReference<EntertainmentMainActivity> weakActivity = new WeakReference<>(this);
...
//                            });
            ...
            ModelRenderable.builder()
                    ...
                    .build()
                    .thenAccept(model -> {
                        EntertainmentMainActivity activity = weakActivity.get();
                        if (activity != null) {
...
//                            });
    ...
    public void onTapPlane(HitResult hitResult, Plane plane, MotionEvent motionEvent) {
        ...
        anchorNodeText.setParent(arFragment.getArSceneView().getScene());
            ...
            displayText.select();
            title(anchorNode, displayText, "ENTERTAINMENT\n" +
                    "\nPRICE\n" +
                    "RM2,199.50\n" +
                    "\n" +
